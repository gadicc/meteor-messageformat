...
mfPkg = {
    ...
    mfStrings: Mongo ? new Mongo.Collection('mfStrings') : new Meteor.Collection('mfStrings'),
    mfRevisions: Mongo ? new Mongo.Collection('mfRevisions') : new Meteor.Collection('mfRevisions'),
    mfMeta: Mongo ? new Mongo.Collection('mfMeta') : new Meteor.Collection('mfMeta'),
